...
require("minitest/autorun") #gems are in a fixed location
require_relative("../my_functions") #specify location of file
# no need to include .rb as ruby can only work with .rb files
